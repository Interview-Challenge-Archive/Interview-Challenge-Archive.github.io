...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      vitePlugins: [
        yaml({ include: ['**/src/config/feature-flags.yml', '**/src/config/colors.yml', '**/src/config/auth.yml', '**/src/config/about.yml', '**/src/config/github_api.yml', '**/src/config/cache.yml'] }),
